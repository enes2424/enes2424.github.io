...
const translations = {
    "tr": {
        ...
        "edu-42-about": "Akran öğrenimi ve tamamen uygulama odaklı bir sistemde yazılım geliştirme süreçlerini deneyimliyorum.",
        ...
        "modal-default-desc": "Detaylı çalışma notları ve kaynak kodlar ilgili proje başlıkları altında yer almaktadır.",
    ...
    "en": {
        ...
        "about-p1": "I started my journey in Erzincan. I built a solid foundation by graduating as the **valedictorian** from Mustafa Doğan Anatolian High School. Then, achieving a rank of **5802nd** in the numerical field in the 2020 YKS exam in Turkey, I was accepted to the Computer Engineering department of Yeditepe University with a **100% full scholarship** and graduated after 5 years of education.",
        "about-p2": "In addition to my university education, I had the chance to develop myself within **42 Kocaeli**, a project-oriented ecosystem with 'teacherless' peer-to-peer learning located in Bilişim Vadisi. In this innovative school, which I discovered through a club trip in my 2nd year, I learned to create solutions to real-world problems with code.",
        "about-p3": "Moving beyond formal education, I kept my problem-solving muscles active by completing nearly 400 algorithmic exercises on platforms like **Exercism** and **LeetCode**. This disciplined work process provided me the opportunity to participate in many freelance projects specializing in **Flutter** and **Backend** technologies and develop commercial products.",
        "about-p4": "Today, I am a developer combining engineering discipline with a curious developer spirit, ready to produce solutions at every layer, from low-level systems to modern mobile application architectures.",
        ...
        "edu-42-about": "I am experiencing software development processes in a peer-to-peer learning and fully application-oriented system.",
        ...
        "modal-default-desc": "Detailed study notes and source codes are available under relevant project headings.",
        "visit-app": "Go to App ↗",
        "lang-en": "English",
        "lang-tr": "Türkçe",
...
function updateLanguageUI() {
    ...
    document.getElementById("lang-text").textContent = currentLang === "en" ? "TR" : "EN";
...
function toggleLanguage() {
    ...
    updateLanguageUI();
    loadRepos(); // Reload projects to update their descriptions
}
